<div id="ufinance_app" class="ufinance advanced_details">
    ...
    <b-modal 
        ...
        <div v-if="form_ai.api_key.length > 0">
            ...
            <p class="font-weight-light text-white-50"><small>Conversations are not stored. Save relevant information in notes. Contextual data is parsed only on the summary page. The quality of the data generated by LLMs is limited; do not use it for financial or investment advice.</small></p>
        </div>
